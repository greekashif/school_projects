...
<meta name="author" content="Kashif Ahmadi">
<!-- Credit for Bootstrap code: Mark Otto, Jacob Thornton, and Bootstrap contributors -->
...
<div class="container">
	<table class="table">
		...
		<tbody>
		<c:forEach items="${browse}" var="browse">
			<tr>
				<td><a href="show?title=${browse.title}">${browse.title}</a></td>
				<td>${browse.rating}/5</td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
